...
**/
      ...
      y += 22;
      x = 154 - 16;  //width of highscore - width of number
...
**/
	...
	m_imagePacman = m_gameModel.m_pacMan.getImage (m_gameModel.m_pacMan.getCodeBase (), "logo_small.jpg");
        highscore = m_gameModel.m_pacMan.getImage (m_gameModel.m_pacMan.getCodeBase(), "highscore.jpg");
        tracker.addImage(highscore, 0);
	oneup = m_gameModel.m_pacMan.getImage (m_gameModel.m_pacMan.getCodeBase(), "1up.jpg");
